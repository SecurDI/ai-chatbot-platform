...
export default function DashboardLayout({
  ...
  console.log("Rendering frontend/app/(dashboard)/layout.tsx");
  ...
  return (
    <div className="min-h-screen bg-securdi-dark-bg flex glow-background">
      ...
      <aside
        ...
        } bg-securdi-dark-bg/80 backdrop-blur-xl border-r border-securdi-accent/20 transition-all duration-300 overflow-hidden flex flex-col shadow-xl fixed h-full z-40 lg:relative`}
      >
        <div className="p-6 border-b border-securdi-accent/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/SecurDI-logo-white-1-1.png.webp" alt="SecurDI Logo" className="w-16 h-16" />
            </div>
            <button
            ...
            return (
              <a
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all ${
                  isActive
                    ? "bg-securdi-accent/10 text-securdi-accent border border-securdi-accent/20 shadow-sm shadow-securdi-accent/10"
                    : "text-slate-300 hover:bg-securdi-accent/10 hover:text-securdi-text-light"
                }`}
              >
      ...
      <div className="flex-1 flex flex-col min-h-screen lg:ml-0">
        {/* Top Bar */}
        <header className="bg-securdi-dark-bg/60 backdrop-blur-md border-b border-securdi-accent/20 px-8 py-6 shadow-sm sticky top-0 z-30">
