...
/**
 * Entra Settings Content Component
 * Allows admins to configure Entra ID (Azure AD) settings
 */
export default function EntraSettingsContent() {
  console.log("⚙️ EntraSettingsContent component rendering");
  ...
  return (
    <div className="min-h-screen bg-securdi-dark-bg wave-background p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Entra ID Settings</h1>
          <p className="text-gray-400">Configure your Azure Active Directory / Entra ID integration</p>
        </div>

        {/* Organization Info Card */}
        <div className="backdrop-blur-xl bg-[#0A0A0A]/40 border-2 border-[#7dd3c0] rounded-3xl p-8 mb-8 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="mt-2 text-lg text-white">SecurDI Corp</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-400">Organization ID</label>
              <p className="mt-2 text-lg text-white">org_securdi_12345</p>
            </div>
          </div>
        </div>
          ...
          {entraConfig ? (
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-lg text-white">{entraConfig.tenant_id}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-400">Client ID</label>
                <p className="mt-1 text-lg text-white">{entraConfig.client_id}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1 text-lg text-white">{entraConfig.redirect_uri}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-400">Custom Domain</label>
                <p className="mt-1 text-lg text-white">{entraConfig.domain || "N/A"}</p>
              </div>
              ...
              <div className="mt-6 flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-[#7dd3c0]/10 hover:bg-[#7dd3c0]/20 text-white rounded-xl font-semibold transition-all"
                >
            ...
            <div className="text-gray-400 text-lg flex items-center gap-2">
              ...
              <button
                onClick={() => setEditMode(true)}
                className="ml-4 px-4 py-2 bg-[#7dd3c0]/10 hover:bg-[#7dd3c0]/20 text-white rounded-xl font-semibold transition-all"
              >
                Configure Now
              </button>
            </div>
        ...
        {editMode && (
          <div className="backdrop-blur-xl bg-[#0A0A0A]/40 border-2 border-[#7dd3c0] rounded-3xl p-8 shadow-xl mt-8">
            <h2 className="text-2xl font-bold text-white mb-6">Edit Entra ID Configuration</h2>
